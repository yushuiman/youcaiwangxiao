    ...
    <div class="background">
      <div class="con" v-if="isForget == 'log-reg'">
        ...
        <div v-if="isLogin == 'reg'">
          ...
          <div class="tel">
            <img :src="phone" alt="">
            <input v-model.trim="form2.mobile" placeholder="请输入手机号" maxlength="11">
          </div>
          <div class="tel">
            <img :src="code" alt="">
            <input type="text" v-model.trim="form2.code" placeholder="请输入手机验证码" maxlength="6">
          ...
          <div class="read">
            ...
            <Modal
              ...
              @on-ok="agreeOk"
              width="1000">
              <div class="content agree-cont">
                <div class="content">
                  本用户协议双方为优财网校(www.youcaiwx.cn)所有者优财CMA培训中心与网校使用学员，本协议具有法律效力。学员须遵守本用户协议，并在本协议中承诺遵守所有优财培训中心已经发布的或将来可能发布的各类规则。
                </div>
        ...
        <div v-if="isLogin == 'fast_login'">
          ...
          <div class="tel">
            <img :src="phone" alt="">
            <input v-model.trim="form4.mobile" placeholder="请输入手机号" maxlength="11"/>
          </div>
          <div class="tel">
            <img :src="code" alt="">
            <input type="text" v-model.trim="form4.code" placeholder="请输入手机验证码" maxlength="6" @keyup.enter="quickLogin">
      ...
      <div class="forget-pwd" v-if="isForget == 'forget'">
        ...
        <div class="tel">
          <img :src="phone" alt="">
          <input v-model.trim="form3.mobile" placeholder="请输入手机号" maxlength="11">
        </div>
        <div class="tel">
          <img :src="code" alt="">
          <input v-model.trim="form3.code" placeholder="验证码" maxlength="6">
