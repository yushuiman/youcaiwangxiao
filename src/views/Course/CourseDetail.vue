<template>
  <div class="class-detail-wrap w-wrap">
    <div class="nav-title">
      ...
      <router-link to="/course-alsj" v-if="$route.query.from == 2">课程</router-link>
      <router-link to="/course" v-else>课程</router-link><i>></i>
    ...
    getCourseIntroduction () {
      ...
      courseIntroduction({
        ...
        if (res.code === 200) {
          ...
          this.isntroduction.audition_href = res.data.audition_href || 'https://video.youcaiwx.com/1d0e88c44f5b4e0fa5345c330c40dcd0/6c42e7069bf346b28bef71c133b3d0a6-f25f346eebd78e796eef18c5a1ba8711-ld.mp4'
